...
const TokenDropdownInput = ({ initialContent, contentList, Max, backgroundColor }) => {
        ...
        >
          <div className="flex flex-row h-16 px-5 py-5">
            <div className="flex flex-row">
              <img src={selectedContent.url} alt="" style={selectedContent.style} />
                ...
                <div className={"flex flex-col w-64 rounded-b-md " + bgColor}>
                  {contentList.map((content, idx) => {
                    return (
                      ...
                      >
                        <img className="h-6" src={content.url} alt="" style={content.style} />
